      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="max-w-3xl mx-auto text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold relative inline-block">
            ...
            <span className="absolute bottom-1 left-0 w-full h-3 bg-peach/60 -z-0"></span>
          </h2>
        ...
        <div className="mx-auto max-w-5xl">
          ...
          >
            <CarouselContent>
              {features.map((feature, index) => (
                <CarouselItem key={index} className="sm:basis-1/2 md:basis-1/3">
                  <div className="bg-fashion-black border border-fashion-white/20 rounded-xl p-6 md:p-8 h-full hover:shadow-[0_0_15px_rgba(253,225,211,0.3)] transition-all hover:-translate-y-1">
                    ...
                    <div className="bg-peach p-3 rounded-lg inline-block mb-4 text-fashion-black">
                      {feature.icon}
                    </div>
            ...
            <CarouselPrevious className="left-2 lg:-left-12 bg-peach text-fashion-black hover:bg-peach-dark border-none shadow-lg" />
            <CarouselNext className="right-2 lg:-right-12 bg-peach text-fashion-black hover:bg-peach-dark border-none shadow-lg" />
          </Carousel>

          <div className="mt-10 flex justify-center gap-2">
            <span className="block w-2 h-2 rounded-full bg-peach animate-pulse"></span>
            <span className="block w-2 h-2 rounded-full bg-peach/70 animate-pulse" style={{ animationDelay: "0.2s" }}></span>
            <span className="block w-2 h-2 rounded-full bg-peach/50 animate-pulse" style={{ animationDelay: "0.4s" }}></span>
          </div>
        </div>
      </div>
    </section>
